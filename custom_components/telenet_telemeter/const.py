...
PROVIDER_BASE = "BASE"
PROVIDER_TELENET_BUSINESS = "Telenet Business"
PROVIDERS = [PROVIDER_TELENET, PROVIDER_BASE, PROVIDER_TELENET_BUSINESS]

PROVIDER_NAMES = {
    PROVIDER_TELENET: "Telenet Telemeter",
    PROVIDER_BASE: "BASE Telemeter",
    PROVIDER_TELENET_BUSINESS: "Telenet Business Telemeter",
}
...
PROVIDER_CONFIG = {
    ...
    PROVIDER_TELENET_BUSINESS: {
        "api_url":          "https://api.prd.telenet.be",
        "secure_url":       "https://secure.telenet.be",
        "login_callback":   "telenet_be",
        "authorization_url":"https://api.prd.telenet.be/ocapi/login/authorization/telenet_be?lang=nl&style_hint=care&targetUrl=https://www2.telenet.be/business/nl/mytelenet/",
        "origin":           "https://www2.telenet.be",
        "referrer":         "https://www2.telenet.be",
        "alt_referer":      "https://www2.telenet.be/business/nl/mijn-telenet/",
        "maintenance_url":  "https://api.prd.telenet.be/omapi/public/publicconfigs/maintenance_ocapi",
    },
}
